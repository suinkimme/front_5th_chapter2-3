function getTagsForIndex(index: number) {
  const TAG_POOL = [
    "history",
    "fiction",
    "mystery",
  ...
  return [TAG_POOL[start], TAG_POOL[(start + 1) % TAG_POOL.length], TAG_POOL[(start + 2) % TAG_POOL.length]]
}

export const ALL_POSTS = Array.from({ length: 251 }, (_, i) => {
  const id = i + 1
  return {
    id,
    title: `Post Title #${id}`,
    body: `This is the body of post #${id}. It contains some example text that simulates user-generated content.`,
    tags: getTagsForIndex(id),
    reactions: {
...
export const TEST_COMMENTS = [
  {
    id: 1,
    postId: 1,
    body: "This post really made me think. Thanks for sharing.",
    likes: 5,
    user: {
      id: 11,
      username: "johndoe",
  ...
  },
  {
    id: 2,
    postId: 1,
    body: "Not sure I agree, but interesting point.",
    likes: 2,
    user: {
      id: 12,
      username: "janedoe",
  ...
  },
  {
    id: 3,
    postId: 2,
    body: "This was helpful, thank you!",
    likes: 7,
    user: {
      id: 13,
      username: "helpful123",
  ...
  },
  {
    id: 4,
    postId: 2,
    body: "Please cite your sources.",
    likes: 1,
    user: {
      id: 14,
      username: "skeptic",
      fullName: "Skeptical Reader",
    },
  },
  {
    id: 5,
  ...
  },
  {
    id: 6,
    postId: 3,
    body: "More posts like this, please.",
    likes: 6,
    user: {
      id: 16,
      username: "enthusiast",
      fullName: "Post Enthusiast",
    },
  },
  {
    id: 7,
    ...
    user: {
      id: 17,
      username: "relatable",
      fullName: "Relatable Reader",
    },
  },
  {
    id: 8,
    postId: 5,
    body: "Could you explain more?",
    likes: 2,
    user: {
      id: 18,
      username: "confused",
      fullName: "Confused Viewer",
    },
  },
  {
    id: 9,
