...
interface ISelectTriggerProps extends SelectPrimitive.SelectTriggerProps {
  className?: string
}

interface ISelectContentProps extends SelectPrimitive.SelectContentProps {
  position?: "popper" | "item-aligned"
}

interface ISelectItemProps extends SelectPrimitive.SelectItemProps {
  className?: string
}
