...
interface IDialogTitleProps extends DialogPrimitive.DialogTitleProps {
  className?: string
}
...
export const DialogContent = forwardRef<HTMLDivElement, IDialogContentProps>(
...
export const DialogTitle = forwardRef<HTMLHeadingElement, IDialogTitleProps>(({ className, ...props }, ref) => (
